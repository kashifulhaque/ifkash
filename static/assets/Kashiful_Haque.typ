...
- #link("https://www.printweek.com/content/news/fiery-shows-off-new-ai-features-at-printing-united")[Led development of "Beacon"], utilizing LLMs to derive print details from emails to automate printing process.
